...
namespace Codescene.VSExtension.Core.Application.Services.Cli
{
    public interface ICliExecutor
    {
        ...
        IList<FnToRefactorModel> FnsToRefactorFromCodeSmells(string content, string fileName, string codeSmells, string preflight);
        IList<FnToRefactorModel> FnsToRefactorFromDelta(string content, string fileName, string deltaResult, string preflight);
    }
}
