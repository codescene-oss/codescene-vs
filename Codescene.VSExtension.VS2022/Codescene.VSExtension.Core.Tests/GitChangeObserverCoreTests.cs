...
{
    [TestClass]
    public class GitChangeObserverCoreTests
    {
        ...
        private FakeAsyncTaskScheduler _fakeTaskScheduler;
        ...
        public void Setup()
        {
            ...
            _gitChangeObserverCore = CreateGitChangeObserver();
        ...
        private GitChangeObserverCore CreateGitChangeObserver()
        {
