...
{
    [TestClass]
    public class ReviewAsync_InnerReviewerThrows_PropagatesExceptionTests
    {
        ...
        {
            var path = "InnerReviewerThrows_PropagatesException.cs";
            ...
            var exception = await Assert.ThrowsAsync<InvalidOperationException>(() =>
                _cachingReviewer.ReviewAsync(path, content));
            Assert.AreEqual("CLI process failed", exception.Message);
        }
    }
}
