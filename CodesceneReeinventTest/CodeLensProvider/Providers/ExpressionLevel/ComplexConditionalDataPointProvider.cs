...
namespace CodeLensProvider.Providers.ExpressionLevel
{
    ...
    [Name("ComplexConditionalDataPointProvider")]
    [ContentType("csharp")]
    [Priority(101)]
    internal class ComplexConditionalDataPointProvider : IAsyncCodeLensDataPointProvider
    {
        private readonly Lazy<ICodeLensCallbackService> _callbackService;

        [ImportingConstructor]
        public ComplexConditionalDataPointProvider(Lazy<ICodeLensCallbackService> callbackService)
        {
        ...
        {
            var dataPoint = new ComplexConditionalDataPoint(descriptor);
